import { restaurant } from '@/assets/food/restaurant';
...
const Details = () => {
  ...
  const renderItem: ListRenderItem<any> = ({ item, index }) => (
    <Link href={{ pathname: '/(food)/food-dish', params: { id: item.id } }} asChild>
      ...
      {items > 0 && (
        <View style={styles.footer}>
          <SafeAreaView edges={['bottom']} style={{ backgroundColor: '#fff' }}>
            <Link href={'(food)/food-basket' as any} asChild>
